...
export default function ContactSection() {
  return (
    <section className="relative col-span-full grid grid-cols-12 w-full py-20 pb-32 bg-primary-100 bg-[url('../src/assets/images/contactbg.png')] bg-cover bg-center" id="contact">
