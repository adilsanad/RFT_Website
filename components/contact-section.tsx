...
export default function ContactSection({bgColor = "bg-primary-100"}: {bgColor?: string}) {
  return (
    <section className={`relative col-span-full grid grid-cols-4 md:grid-cols-12 w-full py-20 pb-32 ${bgColor} bg-[url('../public/assets/images/contactbg.png')] bg-cover bg-center`} id="contact">
