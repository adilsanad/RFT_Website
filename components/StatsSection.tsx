...
export default function StatsSection() {
  ...
  return (
    <section className="relative col-span-full flex w-full py-24">
      <div className="absolute inset-0 z-10 ">
        <svg className="w-full md:h-full opacity-50" viewBox="0 0 560 746" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 w-full gap-32 z-20 px-4">
