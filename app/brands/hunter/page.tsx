...
export default function Hunter() {
    ...
    return (
        <main className="grid grid-cols-4 md:grid-cols-12 gap-16 md:gap-24 bg-white font-neulissans tracking-tight py-[5.5rem]">
            <section className="col-span-full relative flex flex-col w-full ">
                <div className="flex flex-col w-full px-4 z-10">
                    <div className="relative w-full rounded-[15px_15px_30px_30px] md:rounded-[15px_15px_60px_60px] bg-[#00658A] overflow-hidden ">
                        <div className=" flex flex-col gap-4 p-9 md:px-14 min-h-80 justify-end ">
                            <svg className="max-w-64 md:max-w-xs" viewBox="0 0 330 78" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="col-span-full relative flex flex-col px-4 md:px-24 gap-8">
                <div className="col-span-full flex flex-col gap-12">
                    {/* Dynamic Content */}
                    <div className="min-h-[120px] transition-all duration-300 ease-in-out">
                        <p className="max-md:px-8 text-lg md:text-xl leading-relaxed text-gray-700">
            ...
            <section className={` col-span-full grid grid-cols-4 md:grid-cols-12 gap-12 py-36 md:pt-42 border border-black/15 ${!lightColor && 'bg-primary-100'} rounded-[45px] `}
            style={lightColor ? {backgroundColor: lightColor} : {}}>
                <div className="col-span-full md:col-span-10 md:col-start-2 flex flex-col gap-12 ">
                    <h2 className="font-medium tracking-tighter max-md:px-8">Brand Gallery</h2>
                    <div className="grid grid-cols-2 md:grid-cols-3 max-md:px-4 gap-2 md:gap-5 w-full">
                        <TeamMember
                            name="John Doe"
            ...
            <section className='col-span-full flex flex-col px-4 md:px-24 pr-0 overflow-x-auto'>
