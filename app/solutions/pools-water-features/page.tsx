    ...
    return (
        <main className="grid grid-cols-12 gap-24 bg-white font-neulissans tracking-tight">
            ...
            <section className="col-span-12 relative w-full px-10 bg-primary-100 py-[5.5rem]">
                ...
                <div className="absolute top-96 left-10 w-[49.5vw] h-auto z-10">
                    <div className=" flex flex-col gap-8 justify-end items-start p-16 rounded-[45px_136px_90px_45px] bg-primary-300 border-2 border-primary-900/15">
                        <div className="bg-primary-500 text-primary-900/80 px-8 py-4 rounded-full text-xl font-medium tracking-tight">
                            Pools & Water features
                        </div>
                        <div className="flex flex-col gap-4">
                            <h2 className="">
                                Water bender type shit, pools
                            </h2>
                            <p className="text-xl ">
