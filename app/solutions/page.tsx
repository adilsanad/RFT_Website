            ...
            <section className="md:pl-16 md:pr-0 col-span-full relative flex w-full min-h-[50vh] md:min-h-[58vh] items-center bg-primary-100">
                <div className="flex max-md:flex-col gap-12 w-full pr-0 z-10 items-end">
                    <div className="flex flex-1 flex-col gap-4 md:py-16 md:order-1 order-2 max-md:text-center max-w-xl max-md:pb-12 ">
                        <h2 className="text-6xl font-medium tracking-tight leading-[3.5rem]">Built for Indian landscapes.</h2>
                        <p className="max-md:px-6 text-xl text-black/70">Smart, scalable, and sustainable—our water systems are trusted across India’s toughest climates and most demanding urban spaces.</p>
                    </div>
            ...
            <section className="col-span-full relative flex flex-col md:grid grid-cols-12 gap-24 gap-y-20 md:py-24 md:gap-y-28 px-8 md:px-24">
                <div className="col-span-6 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-black/70 text-lg">From first sketch to final splash, we design and deliver complete water systems — irrigation, rainwater harvesting, and pools — built to last.</p>
                    </div>
                </div>
                <div className="col-span-6 flex flex-col gap-8">
                    <div className="z-10 p-2 flex w-fit rounded-full border-4 border-primary-600 ">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-black/70 text-lg">Every project blends innovation with efficiency, reducing waste and maximising performance without compromising aesthetics.</p>
                    </div>
                </div>
                <div className="col-span-6 flex flex-col gap-8">
                    <div className="z-10 p-2 flex w-fit rounded-full border-4 border-primary-600 ">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-black/70 text-lg">Every project is custom-fit to your property and lifestyle. From discreet irrigation lines to artfully placed water features, we design for both performance and aesthetics, so the end result feels like it’s always been part of your space.</p>
                    </div>
                </div>
                <div className="col-span-6 flex flex-col gap-8">
                    <div className="z-10 p-2 flex w-fit rounded-full border-4 border-primary-600 ">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-black/70 text-lg">We believe great projects don’t end at handover. Our team stays with you for the long run, offering maintenance, performance checks, and timely upgrades so your investment keeps paying off year after year.</p>
                    </div>
                </div>
            </section>
